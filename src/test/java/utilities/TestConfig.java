...
public class TestConfig{
	...
	public static String from = "bruce.auto.101@gmail.com";
	public static String password = "test1234!";
	public static String[] to ={"bmyklebu@gmail.com","bmyklebu@gmail.com"};
	...
	*/
	...
	public static String mysqlpassword = "dieg0";
	public static String mysqlurl = "jdbc:mysql://localhost:3306/brucetest?serverTimezone=UTC";
